...
public class IsoCollider : MonoBehaviour {
	...
	Mesh createMesh()
	{
		...
		#region Vertices
			Vector3 p0 = Isometric.ScreenToIso(new Vector3(-length * .5f, -width * .5f, height * .5f));
			Vector3 p1 = Isometric.ScreenToIso(new Vector3(length * .5f, -width * .5f, height * .5f));
			Vector3 p2 = Isometric.ScreenToIso(new Vector3(length * .5f, -width * .5f, -height * .5f));
			Vector3 p3 = Isometric.ScreenToIso(new Vector3(-length * .5f, -width * .5f, -height * .5f));

			Vector3 p4 = Isometric.ScreenToIso(new Vector3(-length * .5f, width * .5f, height * .5f));
			Vector3 p5 = Isometric.ScreenToIso(new Vector3(length * .5f, width * .5f, height * .5f));
			Vector3 p6 = Isometric.ScreenToIso(new Vector3(length * .5f, width * .5f, -height * .5f));
			Vector3 p7 = Isometric.ScreenToIso(new Vector3(-length * .5f, width * .5f, -height * .5f));
